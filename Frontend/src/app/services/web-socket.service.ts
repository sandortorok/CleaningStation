...
import { aInput, dInput, dOutput } from '../pages/input-output/input-output.component';
...
export class WebsocketService {
  ...
  private speed$ = new BehaviorSubject<{speed1:number, speed2:number, speed3:number}>({speed1:-1, speed2: -1, speed3: -1});
  ...
  openWebSocket(){
    ...
    this.webSocket.onmessage = (event) => {
      ...
      if(this.isJsonString(event.data)){
        ...
        if(data.speed1 != undefined && data.speed2 != undefined && data.speed3 != undefined){
